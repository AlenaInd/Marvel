<template>
    <div id="app">
        ...
        <app-header title="Warvel" :changeSearch="changeSearch"/>

        <div class="container">
            <h1 class="pt-3 pb-3">Персонажи Marvel</h1>

            <h5 v-if="!searchCharacters.length">Не найдено по запросу: {{search}}</h5>
            ...
            <div class="row">
                <div v-for="(el, idx) in searchCharacters" class="card mb-3" 
                :key="el.id"
                style="max-width: 540px;">
        <div class="row g-0">
          <div class="col-md-4">
            <img :src="el.thumbnail" class="img-fluid rounded-start" alt="spiderman">
          </div>
          <div class="col-md-8">
            <div class="card-body">
